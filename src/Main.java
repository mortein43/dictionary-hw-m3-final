...
import com.eizenheim.dictionaryhwm3final.Dictionary;
            ...
            switch (choise) {
                ...
                case 4:
                    ...
                    if (!dictionary.getTranslations(inputWord).isEmpty())
                        out.println("Переклад для слова " + inputWord + ": " + dictionary.getTranslations(inputWord));
                    break;
                case 5:
                    ...
                    switch (choise5) {
                        case 1:
                            ...
                            break;
                        case 2:
                            out.println("Введіть англійське слово до якого потрібно замінити переклад:");
                            ...
                            dictionary.replaceTranslations(inputWord5_2, wordOldTranslation_5_2, wordNewTranslation_5_2);
                            out.println("Переклад успішно змінений.");
                            break;
                        case 3:
                            out.println("Введіть англійське слово для якого поітрбно видалити переклад:");
